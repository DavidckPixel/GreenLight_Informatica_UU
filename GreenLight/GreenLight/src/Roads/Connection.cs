    ...
    class Connection
    {
        ...
        public void StraightandStraight(Point _point1, Point _point2, int _lanes, Point _temp1, Point _temp2, Point _temp3, Point _temp4, AbstractRoad _roadOne, AbstractRoad _roadTwo, char _roadOneEnds, char _roadTwoEnds)
        {
            ...
            if (_roadOne.slp == _roadTwo.slp && _roadOne.slp == 0)
            {
                ...
                else if (_roadOneEnds == 'h' && _roadTwoEnds == 'v')
                {
                    ...
                    General_Form.Main.BuildScreen.builder.roadBuilder.BuildCurvedRoad(_curvedstart, _curvedend, _lanes, "Curved", true, true, _controller.roads[_controller.roads.Count - 2], _controller.roads[_controller.roads.Count - 1]);
                }
                ...
                else if (_roadOneEnds == 'v' && _roadTwoEnds == 'h')
                {
                    ...
                    General_Form.Main.BuildScreen.builder.roadBuilder.BuildCurvedRoad(_curvedstart, _curvedend, _lanes, "Curved", true, true, _controller.roads[_controller.roads.Count - 1], _controller.roads[_controller.roads.Count - 2]);
                }
        ...
        public void StraightandDiagonal(Point _point1, Point _point2, int _lanes, Point _temp1, Point _temp2, Point _temp3, Point _temp4, AbstractRoad _roadOne, AbstractRoad _roadTwo, char _roadOneEnds, char _roadTwoEnds)
        {
            ...
            else if (_roadOneEnds == 'h' && _roadTwoEnds == 'v')
            {
                ...
                _controller.BuildCurvedRoad(_curvedstart, _curvedend, _lanes, "Curved", true, true, _controller.roads[_controller.roads.Count - 2], _controller.roads[_controller.roads.Count - 1]);
            }
            ...
            else if (_roadOneEnds == 'v' && _roadTwoEnds == 'h')
            {
                ...
                _controller.BuildCurvedRoad(_curvedstart, _curvedend, _lanes, "Curved", true, true, _controller.roads[_controller.roads.Count - 1], _controller.roads[_controller.roads.Count - 2]);
            }
        }
    }
}
